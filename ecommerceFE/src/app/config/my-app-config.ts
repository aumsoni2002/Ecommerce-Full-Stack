export default {
  oidc: {
    ...
    redirectUri: 'http://localhost:4200/login/callback', // we will send the user to this url, once they are logged in.
    scopes: ['openid', 'profile', 'email'], // The scope provides access to information about the user.
